...
# Lokalnie możesz użyć python-dotenv (pip install python-dotenv)
...
API_URL = "https://v3.basketball.api-sports.io"
...
def pobierz_mecze_na_jutro():
    ...
    Obsługuje błędy sieciowe i puste odpowiedzi.
    """
    ...
    try:
        ...
        response.raise_for_status() # Zgłosi wyjątek dla statusów 4xx/5xx
        data = response.json()
